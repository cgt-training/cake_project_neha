                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                {
                                 echo $this->Form->postLink(__("<i class='glyphicon glyphicon-trash'></i>"), ['action' => 'delete', $users->id], ['escape'=>false,'confirm' => __('Are you sure you want to delete # {0}?', $users->id)]);
                                }
                                ?>
                            </td>
                        </tr>
