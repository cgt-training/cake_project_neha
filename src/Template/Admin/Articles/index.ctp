                        ...
                        foreach($articles as $article)
                        {
                          ...
                          <tr>
                            ...
                            <td class="actions">
                                ...
                                <?= $this->Form->postLink(__("<i class='glyphicon glyphicon-trash'></i>"), ['action' => 'delete', $article->id],['escape'=>false,'confirm' => __('Are you sure you want to delete # {0}?', $article->id)]) ?>
                            </td>
                          </tr>
                          <?php
                          $sno++;
